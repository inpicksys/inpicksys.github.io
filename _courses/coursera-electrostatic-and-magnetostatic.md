---
permalink: "/coursera-electrostatic-and-magnetostatic/"
layout: page
title: "Coursera - Электростатика и магнитостатика"
description: "Электростатика и магнитостатика"
category: coursera
img: assets/img/coursera-electrostatic-and-magnetostatic.png
importance: 1
...
- [2.6 Локальная теорема Муавра–Лапласа](/stepik-probability_theory-3089/module-2_6-Local-Moivre-Laplace-theorem)
- [2.7 Интегральная теорема Муавра–Лапласа](/stepik-probability_theory-3089/module-2_7-Moivre–Laplace-integral-theorem)
...
- [4.4 Непрерывное распределение](/stepik-probability_theory-3089/module-4_4-Continuous-distribution)
- [4.5 Независимость](/stepik-probability_theory-3089/module-4_5-Independence)
- [4.6 Математическое ожидание](/stepik-probability_theory-3089/module-4_6-Mathematical-Expectation)
- [4.7 Характеристические функции случайных величин](/stepik-probability_theory-3089/module-4_7-Characteristic-functions-of-random-variables)
- [4.8 Центральная предельная теорема](/stepik-probability_theory-3089/module-4_8-Central-Limit-Theorem)


### 8. Магнитное поле в вакууме

- [8.1 Тест](/coursera-electrostatic-and-magnetostatic/week-8-test)
- [4.2 Производящие функции](/stepik-probability_theory-3089/module-4_2-generating-functions)
- [4.3 Лемма Бореля–Кантелли](/stepik-probability_theory-3089/module-4_3-Borel–Cantelli-lemma)
- [4.4 Непрерывное распределение](/stepik-probability_theory-3089/module-4_4-Continuous-distribution)
- [4.5 Независимость](/stepik-probability_theory-3089/module-4_5-Independence)
