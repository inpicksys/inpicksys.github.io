    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
            ...
            window.location.href = "/blog/2026/di-aop-part-2/";
          
        },
      },{id: "post-законы-масштабирования",
        ...
        handler: () => {
            ...
            window.location.href = "/blog/2026/scaling-laws/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6D%69%6B%68%61%69%6C.%73%74%72%75%74%69%6E%73%6B%79@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/inpicksys", "_blank");
        },
      },{
        id: 'social-inspire',
        title: 'Inspire HEP',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/mikhail-s-996581a5", "_blank");
        },
      },{
        id: 'social-medium',
        title: 'Medium',
        section: 'Socials',
        handler: () => {
          window.open("https://medium.com/@strmisha.s", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=cGALo4gAAAAJ&hl", "_blank");
        },
      },{
        id: 'social-coursera_id',
        title: 'Coursera_id',
        section: 'Socials',
        handler: () => {
          window.open("", "_blank");
