...
<div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/di-aop/dependency_inversion_principle.png" class="img-fluid rounded z-depth-1" zoomable=true %}
</div>
...
<div class="col-sm mt-3 mt-md-0">
  {% include figure.liquid path="assets/img/di-aop/control_inversion.png" class="img-fluid rounded z-depth-1" zoomable=true %}
</div>
...
<div class="col-sm mt-3 mt-md-0">
  {% include figure.liquid path="assets/img/di-aop/inversions.png" class="img-fluid rounded z-depth-1" zoomable=true %}
</div>
...
<div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/di-aop/cross-cutting-concerns.png" class="img-fluid rounded z-depth-1" zoomable=true %}
</div>
